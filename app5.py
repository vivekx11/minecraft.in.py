...
BLOCK_TYPES = {
    'grass': {'color': color.rgb(34, 139, 34), 'texture': 'white_cube'},
    'stone': {'color': color.rgb(128, 128, 128), 'texture': 'white_cube'},
    'wood': {'color': color.rgb(139, 90, 43), 'texture': 'white_cube'},
    'sand': {'color': color.rgb(238, 214, 175), 'texture': 'white_cube'},
...
# Optimized terrain generation - smaller and flatter
